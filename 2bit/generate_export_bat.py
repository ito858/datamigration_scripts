...
queries = [
    ...
    ("SELECT idcliente, REPLACE(REPLACE(REPLACE(REPLACE(ragionesociale1, CHAR(13), ''), CHAR(10), ''), '|', ' '), '\', ' ') as ragionesociale1, indirizzo, cap, paese, provincia, telefono, email, partitaiva, codicefiscale, emailpec, codiceunivocoufficio, fornitore, cliente, contatto, REPLACE(REPLACE(REPLACE(REPLACE(ragionesociale2, CHAR(13), ''), CHAR(10), ''), '|', ' '), '\', ' ') as ragionesociale2 FROM dbo.tabClienti", "tabClienti.csv"),
